                                                            ...
                                                            class="root___2YHfw6NQ root--type-month___1F7YZY6P"><span
                                                                ...
                                                                class="monthDay___3pDBSn6O"><span
                                                                    class="month___n-gDfV73"><span
                                                                        ...
                                                                        class="japanese___3zox1MSj f_month_letter">月</span></span><span
                                                                    class="day___2nSLbEke"><span
                                                                        ...
                                                                        class="japanese___3zox1MSj">日<span
                                                                            class="wday___3OSLiv9a">（<span
                                                                                class="">水</span>）</span></span></span></span></span>
                                                    </div>
                                                            ...
                                                            class="root___2YHfw6NQ root--type-month___1F7YZY6P"><span
                                                                ...
                                                                class="monthDay___3pDBSn6O"><span
                                                                    ...
                                                                    class="day___2nSLbEke"><span
                                                                        ...
                                                                        class="japanese___3zox1MSj">日<span
                                                                            class="wday___3OSLiv9a">（<span
                                                                                class="">金</span>）</span></span></span></span></span>
                                                    </div>
                                                </div>
    ...
    <div class="centerSpacer___v9JlAllu" id="centerSpacer">
        <div class="root___krwNb48I">
            <div class="left___CpQxIMS-">
                <div class="leftItem___Li615BII"><button type="button"
                        class="root___2eBX69w2 root--type-secondary___3AvZkzCb"><span
                            class="icon___z9lJByho"><span
                                class="shifticon shifticon-assist "></span></span>シフト作成アシストを実行する</button>
                </div>
                <div class="leftItem___Li615BII"><span class="assistHelp___2vb0TgJX">
                        <div class="wrapper___1gxWggJg"><span class="iconWrapper___3Rlm-Yit"
                                style="font-size: 20px;"><span
                                    class="shifticon shifticon-question-circle "></span></span></div>
                    </span></div>
            </div>
...
<script src="{{ asset('assets/js/service/datesetting.js') }}"></script>
@endsection
